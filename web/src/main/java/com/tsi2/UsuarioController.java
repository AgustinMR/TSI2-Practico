...
@WebServlet(name = "UsuarioController", urlPatterns = {"/usuario"}, value = "/usuario")
public class UsuarioController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (req.getSession().getAttribute("username") != null && !req.getSession().getAttribute("rol").equals("Admin")) {
            ...
            templateEngine.process("usuarios", ctx, resp.getWriter());
        } else {
